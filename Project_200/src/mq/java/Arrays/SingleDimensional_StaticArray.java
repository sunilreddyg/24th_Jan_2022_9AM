...
public class SingleDimensional_StaticArray 
{
	...
	public static void main(String[] args) 
	{
		...
		//Store Group values [String, Integers,boolean]
		...
		boolean phonestatus=(boolean)obj[1];
		double phoneprice=(double) obj[2];
		int quantity=(int) obj[3];
		
		System.out.println(phonename+"\t"+phonestatus+"\t"+phoneprice+"\t"+quantity);
