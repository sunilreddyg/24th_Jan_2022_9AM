...
public class SwitchTo_Frame_Using_WebElement_Reference {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    //switch to frame with WebElement Reference
	    driver.switchTo().frame(driver.findElement(By.className("spinnerMedium")));
